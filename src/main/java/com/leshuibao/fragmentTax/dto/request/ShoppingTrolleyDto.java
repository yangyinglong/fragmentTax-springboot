...
public class ShoppingTrolleyDto {
    ...
    public ShoppingTrolleyDto(String goodsName, String goodsTpey, String measureUnit, Integer buyedNum, float price, float salesVolume, float tax, float taxAmount) {
        this.goodsName = goodsName;
        this.goodsTpey = goodsTpey;
    ...
    public String getGoodsTpey() {
        return goodsTpey;
    }

    public void setGoodsTpey(String goodsTpey) {
        this.goodsTpey = goodsTpey;
    }
